...
#write.csv(all_bold, here("data", "dada_may", "combined", "taxonomies", #"bold.csv"))

IDs_bold <- read.csv(here("data", "dada_may", "combined", "taxonomies", "bold.csv"))

IDs <- IDs_ncbi %>%
  full_join(IDs_bold, by = "ASV")
```