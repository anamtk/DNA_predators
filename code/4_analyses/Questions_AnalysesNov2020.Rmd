...
Boxplot by species
  ...
  + CEN and PAN have proportionally smaller prey items in proportion to their body size, suggesting potentially greater gape limitation in these predator species
  
  + EUB has proportionally larger prey items in comparison to their body size, suggesting a life history strategy (their forceps, perhaps) that allow them to attack larger prey. Conversely, these predators are also well-known scavengers, so this large prey item detection could be evidence of scavenging as opposed to active predation.
